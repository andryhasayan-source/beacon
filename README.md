...
<img src="docs/screenshots/icon.png" alt="Beacon" width="96"/>

# Beacon — Маяк

**Тихий помощник для Windows · Quiet Windows productivity tool**

[![Platform](https://img.shields.io/badge/Windows-10%20%2F%2011-blue?logo=windows)](https://github.com/andryhasayan-source/beacon/releases)
[![Release](https://img.shields.io/github/v/release/andryhasayan-source/beacon?color=orange)](https://github.com/andryhasayan-source/beacon/releases)
[![Developer](https://img.shields.io/badge/developer-ShashevPro-gold)](https://www.shashevpro.ru/)
...
|:---:|:---:|
| ![Задачи](docs/screenshots/tasks_ru.png) | ![Заметки](docs/screenshots/notes_ru.png) |

| Хранилище паролей | Стикеры на рабочем столе |
|:---:|:---:|
| ![Пароли](docs/screenshots/passwords_ru.png) | ![Стикеры](docs/screenshots/stickers_ru.png) |

| Настройки | Меню трея |
|:---:|:---:|
| ![Настройки](docs/screenshots/settings_ru.png) | ![Трей](docs/screenshots/tray_ru.png) |
...
|:---:|:---:|
| ![Tasks](docs/screenshots/tasks_en.png) | ![Notes](docs/screenshots/notes_en.png) |

| Password vault | Desktop stickers |
|:---:|:---:|
| ![Passwords](docs/screenshots/passwords_en.png) | ![Stickers](docs/screenshots/stickers_en.png) |

| Settings | Tray menu |
|:---:|:---:|
| ![Settings](docs/screenshots/settings_en.png) | ![Tray](docs/screenshots/tray_en.png) |
